  ...
  <div class="min-h-screen flex flex-col">
    <header class="navbar bg-base-100 shadow-sm mb-4">
      <div class="navbar-start flex flex-col gap-1 items-start">
        <router-link
          :to="{ name: 'Home' }"
          class="text-xl link link-hover font-bold lg:text-2xl"
        >
          Know Every
          Year
        </router-link>
        <small class="text-sm">by <a
    ...
    <footer class="footer sm:footer-horizontal footer-center bg-base-300 text-base-content p-4">
      <aside>
        <ul class="flex flex-col gap-2">
          ...
          <li>
            Nothing tracked except page views (with the privacy-friendly <a
          ...
          <li>
            This app is <a
              href="https://github.com/koljapluemer/know-every-year"
              class="link"
            >open source</a>.
          </li>
